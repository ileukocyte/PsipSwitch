...
namespace PsipSwitch {
    ...
    internal struct NetworkStats {/*
        public long Ethernet2Counter { get; set; }
        public long ArpCounter { get; set; }
        public long Ipv4Counter { get; set; }
        public long TcpCounter { get; set; }
        public long UdpCounter { get; set; }
        public long IcmpCounter { get; set; }
        public long HttpCounter { get; set; }
        public long HttpsCounter { get; set; }
    ...
    internal struct MacAdressTableRecord {
